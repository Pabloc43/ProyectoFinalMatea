...
export default function FormCarrito() {
    ...
    return (
      <Form id='FormCarrito' noValidate validated={validated} onSubmit={handleSubmit} className="w-25 p-4 d-block text-light">
        <Row className="mb-3">
        ...
        <Button className='botonCompra'type="submit">Realizar compra</Button>
      </Form>
    );
  }
